...
var wasmBinaryFile = 'clipper.wasm';
...
var real___Z9fibonaccii = asm["__Z9fibonaccii"];
asm["__Z9fibonaccii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___Z9fibonaccii.apply(null, arguments);
};
Module["asm"] = asm;
var __Z9fibonaccii = Module["__Z9fibonaccii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z9fibonaccii"].apply(null, arguments)
};
;
